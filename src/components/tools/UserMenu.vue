  ...
  <div class="user-wrapper" :class="theme">
    ...
    <a-dropdown>
      ...
      <a-menu slot="overlay" class="user-dropdown-menu-wrapper">
        ...
        <a-menu-item key="6" @click="updatePayPassword">
          <a-icon type="setting"/>
          <span>支付密码修改</span>
        </a-menu-item>
    ...
    <user-pay-password ref="userPayPassword"></user-pay-password>
...
<script>
  ...
  import UserPayPassword from './UserPayPassword'
  ...
  export default {
    ...
    methods: {
      ...
      updatePayPassword(){
        let username = this.userInfo().username
        this.$refs.userPayPassword.show(username)
      },
      updateCurrentDepart(){
