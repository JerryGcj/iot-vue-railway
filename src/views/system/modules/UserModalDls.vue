  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        that.$nextTick(() => {
          that.form.setFieldsValue(pick(this.model,'username','sex','realname','email','phone','activitiSync','workNo','telephone','post','status','subordinatePartnerId','profitShare','userCompany','note'))
        });
        // 调用查询用户对应的部门信息的方法
