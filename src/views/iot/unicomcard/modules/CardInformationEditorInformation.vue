  ...
  export default {
    ...
    methods: {
      ...
      handleOk () {
          ...
          postAction('unicomcardinformation/unicomCardInformation/ImportExcelEditorCard', formData).then((res) => {
      ...
      exportXlsCardTemplate(fileName){
        ...
        downFile('/unicomcardinformation/unicomCardInformation/exportXlsCardTemplate',param).then((data)=>{
          if (!data) {
