    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="价格(元)">
          <a-input placeholder="请输入价格" v-decorator="['cost', validatorRules.cost]" />
        </a-form-item>
        <!--<a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="卡备注">
          <a-textarea placeholder="请输入卡备注" v-model="note"/>
        </a-form-item>-->
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if(!err){
            ...
            //formData.append('remark',values.note);
            let httpurl = '/unicomcardinformation/unicomCardInformation/cardDistribution';
            let method = 'post';
