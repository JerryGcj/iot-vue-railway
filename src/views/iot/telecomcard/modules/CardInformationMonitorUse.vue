      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if(!err){
            ...
            postAction("/telecomcardinformation/telecomCardInformation/handleMonitorUse", {ids: ids,monitorUse:this.monitorUse,thresholdUsage:values.thresholdUsage}).then((res)=>{
              if(res.success){
