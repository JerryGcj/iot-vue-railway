    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="新价格">
          <a-input v-decorator="[ 'cost', validatorRules.cost]" placeholder="请输入价格"></a-input>
        </a-form-item>
...
<script>
  ...
  export default {
    name: "CardInformationModifyPrice",
    data () {
      return {
        title:"操作",
        visible: false,
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if(!err){
            ...
            let httpurl = '/telecomcardinformation/telecomCardInformation/modifyPrice';
            let method = 'post';
