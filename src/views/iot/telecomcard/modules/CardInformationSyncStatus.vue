  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'monitorUse'))
          //时间格式化
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if(!err){
            ...
            postAction("/telecomcardinformation/telecomCardInformation/syncCardStatus", {ids: ids,monitorUse:this.monitorUse}).then((res)=>{
              if(res.success){
