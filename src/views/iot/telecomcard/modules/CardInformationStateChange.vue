      ...
      <a-form :form="form">
        ...
        <a-form-item
          ...
          <a-select v-decorator="[ 'state', validatorRules.state]" placeholder="请选择">
            <!--<a-select-option value="1">可激活</a-select-option>
            <a-select-option value="2">测试激活</a-select-option>
            <a-select-option value="3">测试去激活</a-select-option>-->
            <a-select-option value="4">激活</a-select-option>
            <a-select-option value="5">停机</a-select-option>
            <!--<a-select-option value="6">运营商管理状态</a-select-option>
            <a-select-option value="7">拆机</a-select-option>
            <a-select-option value="10">高危禁用</a-select-option>-->
          </a-select>
        </a-form-item>
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if(!err){
            ...
            let httpurl = '/telecomcardinformation/telecomCardInformation/stateUpdate';
            let method = 'post';
