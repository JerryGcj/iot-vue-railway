  ...
  export default {
    ...
    methods: {
        ...
        this.form.validateFields((err, values) => {
          if(!err){
            ...
            if(values.importType == '0'){
              ...
              postAction('enterprise/iotEnterpriseCardInfo/cardImportExcel', formData).then((res) => {
      ...
      exportCardXlsCard(fileName){
        ...
        downFile('/enterprise/iotEnterpriseCardInfo/exportCardXlsCard',param).then((data)=>{
          if (!data) {
