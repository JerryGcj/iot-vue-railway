...
<script>
  ...
  import {queryLowerAgent,isRealNameAuthentication } from '@/api/api'

  export default {
    name: "CardInformationRealNameAuthentication",
    data () {
      return {
        title:"操作",
        visible: false,
    ...
    methods: {
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          ...
          isRealNameAuthentication({ids: ids,state:values.state}).then((res)=>{
            if(res.success){
